...
\section*{\small{Maxwell's Equations}}
...
$$\textrm{General EM equation for E-field: } \nabla^2\vec{E} = \mu_0\epsilon_0\kappa \frac{\delta^2 \vec{E}}{\delta t^2} = \frac{1}{c^2}\frac{\delta^2 \vec{E}}{\delta t^2}$$
$$\textrm{General EM equation for B-field: } \nabla^2\vec{B} = \frac{1}{c^2}\frac{\delta^2 \vec{B}}{\delta t^2}$$

\section*{\small{Chapter 29}}
